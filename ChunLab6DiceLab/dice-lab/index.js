...
var timesToPlay = prompt("How many times will you play?");
...
function whoWon() {
    ...
    document.querySelector("h3").innerHTML = banner + "<br>" + "your balance is " + balance;
}
...
let text1 = "";
for (let i = timesToPlay; i > 0; i--) {
  text1 += "The number of rolls remaining is " + i + "<br>"
}
